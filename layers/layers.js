...
lyr_UnidadesVegetacionChubut_0.set('fieldAliases', {'CODIGO': 'CODIGO', 'REGION': 'REGION', 'DOMINIO': 'DOMINIO', 'UNID_FITOG': 'UNID_FITOG', 'NOMFISONOM': 'Nombre', 'NOMVULGAR': 'NOMVULGAR', 'SUP_HA': 'SUP_HA', 'X': 'X', 'Y': 'Y', 'ROTATION': 'ROTATION', });
lyr_RiosDelChubut_1.set('fieldAliases', {'RIO_PER_': 'RIO_PER_', 'NOMBRE': 'NOMBRE', 'CUENCA': 'CUENCA', });
lyr_LocalidadesCHUBUT_2.set('fieldAliases', {'gid': 'gid', 'nombre_geo': 'Nombre', 'tipo_asent': 'tipo_asent', 'codigo_ase': 'codigo_ase', 'nombre_agl': 'nombre_agl', 'codigo_agl': 'codigo_agl', 'nombre_dep': 'nombre_dep', 'codigo_ind': 'codigo_ind', 'nombre_pro': 'nombre_pro', 'codigo_in0': 'codigo_in0', 'latitud_gr': 'latitud_gr', 'longitud_g': 'longitud_g', 'latitud_g0': 'latitud_g0', 'longitud_0': 'longitud_0', 'fuente_de_': 'fuente_de_', });
...
lyr_RiosDelChubut_1.set('fieldLabels', {'RIO_PER_': 'hidden field', 'NOMBRE': 'inline label - always visible', 'CUENCA': 'hidden field', });
