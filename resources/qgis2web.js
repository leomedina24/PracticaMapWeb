...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8101751.226264, -5794464.109298, -6696558.240462, -5103541.115260], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-8101751.226264, -5794464.109298, -6696558.240462, -5103541.115260], map.getSize());
    ...
    element: (() => {
        ...
        if (26 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Leonardo Medina<br />SIG Y TELE';
            }
